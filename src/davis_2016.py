...
#        return processed_file_names
        processed_file_names = os.listdir('pg_datasets/DAVIS_2016/processed')
        if self.train:
            final_processed_file_names = []
            for i in processed_file_names:
                sequence = i.split("_")[0]
                if sequence in self.train_sequences:
                    final_processed_file_names.append(i)
        else:
            final_processed_file_names = []
            for i in processed_file_names:
                sequence = i.split("_")[0]
                if sequence in self.val_sequences:
                    final_processed_file_names.append(i)
        return final_processed_file_names
